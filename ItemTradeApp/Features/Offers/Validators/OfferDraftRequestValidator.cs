...
public class OfferDraftRequestValidator : AbstractValidator<OfferDraftRequest>
{
    public OfferDraftRequestValidator()
    {
        RuleFor(x => x.Title)
            .NotEmpty()
            .MinimumLength(3)
        ...
        RuleFor(x => x.DurationDays)
            .Must(d => d is 7 or 14 or 31)
            .WithMessage("Duration must be 7, 14 or 31.");
